...
def parse_args():
    ...
    parser.add_argument(
        '-p1', '--player1',
        help='Player 1 - black - options: "human", "random", "random_grouping", "dev_nn_nath" or "dev_nn_ben"',
        default='random')
    parser.add_argument(
        '-p2', '--player2',
        help='Player 2 - white - options: "human", "random", "random_grouping", "dev_nn_nath" or "dev_nn_ben"',
        default='random')
    parser.add_argument(
        '-r', '--replay',
